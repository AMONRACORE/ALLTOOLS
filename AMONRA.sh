...
echo
echo $pur"==================="$cy" ============================="
echo $i"Ôûê"$pu"  AUTHOR  :  AMONRA  "$i"                    Ôûê"
echo $i"Ôûê"$pu"  WhatsApp:  XXXXXXXXXXXX"$i"                Ôûê"
echo $i"Ôûê"$pu"  GMAIL   :  MARJO.CHANNELS@gmail.com"$i"    Ôûê"
echo $i"Ôûê"$pu"  YOUTUBE :  YouTube MARJO CHANNELS"$i"      Ôûê"
echo $pur"==================="$cy" ============================="
echo
...
echo
echo $pur"Ôò¡ÔöÇ["$pur"MASUKAN PILIHAN"$pur"]"
read -p"Ôò¦ÔöÇ>> " pil
...
sleep 2
echo $i"SEMOGA BERMANFAAT"
sleep 2
echo $pur"THANKS FOR ALL SUPPORT"
sleep 2
echo $ku"Facebook :"$i" Amar Johani           "
echo $ku"YouTube  :"$i" YouTube MARJO CHANNELS"
echo $ku"WhatsApp :"$i" XXXXXXXXXXXXXXXXXXXXXX"
sleep 2
echo $pur"THANKS FOR SUPPORT"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { YOUTUBE MARJO CHANNELS }"
exit
fi
